...
public static Codificar compact = new Codificar();
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(compactarB, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jButton1.setText("Seleccionar archivo (.txt .docx)");
        ...
        fondo10.setBackground(new java.awt.Color(18, 26, 51));
        fondo10.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir")+"\\src\\main\\java\\images\\grafico.png"));
        jPanel6.add(fondo10);
        fondo10.setBounds(590, 10, 30, 30);
        ...
        tituloHuffman.setText("COMPACTAR ARCHIVO");
        tituloHuffman.setToolTipText("");
        aux0.add(tituloHuffman, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 620, -1));

        background1.add(aux0, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, 540, 40));
        ...
        fondo7.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir")+"\\src\\main\\java\\images\\a.gif"));
        fondo7.setText("jLabel6");
        background1.add(fondo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 30, 580, 80));
    ...
    private void compactarBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compactarBActionPerformed
        ...
        if(ruta_antes.getText().isEmpty()){
            ...
            ruta_despues.setText(compact.getArchivoCodificado());
    ...
    private void estadisticasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_estadisticasActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "\n"
                    ...
                    + "- Tamaño del archivo compactado: " + compact.tamanioCodificado() + " Bytes\n"
